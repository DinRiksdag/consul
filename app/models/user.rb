class User < ActiveRecord::Base
  ...
  validates :personnummer, uniqueness: true, if: :personnummer_required?
  ...
  # overwritting of Devise method to allow login using email OR username OR personnummer
  def self.find_for_database_authentication(warden_conditions)
    ...
    where(conditions.to_hash).where(["personnummer = ?", login]).first
  end
